...
/**
 * This is the ForwardVelocityTuner autonomous follower OpMode. This runs the tests.robot forwards at max
...
public class ForwardVelocityTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("The tests.robot will run at 1 power until it reaches " + DISTANCE + " inches forward.");
        telemetryA.addLine("Make sure you have enough room, since the tests.robot has inertia after cutting power.");
        telemetryA.addLine("After running the distance, the tests.robot will cut power from the drivetrain and display the forward velocity.");
     ...
     * velocities, and when the tests.robot has run forward enough, these last velocities recorded are
