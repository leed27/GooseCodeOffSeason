...
/**
 * This is the ForwardZeroPowerAccelerationTuner autonomous follower OpMode. This runs the tests.robot
 * forward until a specified velocity is achieved. Then, the tests.robot cuts power to the motors, setting
...
public class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("The tests.robot will run forward until it reaches " + VELOCITY + " inches per second.");
