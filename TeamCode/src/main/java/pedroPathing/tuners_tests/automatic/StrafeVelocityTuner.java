...
/**
 * This is the StrafeVelocityTuner autonomous follower OpMode. This runs the tests.robot right at max
 ...
 * You can adjust the distance the tests.robot will travel on FTC Dashboard: 192/168/43/1:8080/dash
 *
...
public class StrafeVelocityTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("The tests.robot will run at 1 power until it reaches " + DISTANCE + " inches to the right.");
        telemetryA.addLine("Make sure you have enough room, since the tests.robot has inertia after cutting power.");
        telemetryA.addLine("After running the distance, the tests.robot will cut power from the drivetrain and display the strafe velocity.");
     ...
     * velocities, and when the tests.robot has run sideways enough, these last velocities recorded are
