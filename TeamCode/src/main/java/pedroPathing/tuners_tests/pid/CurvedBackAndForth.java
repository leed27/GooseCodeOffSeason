...
/**
 * This is the CurvedBackAndForth autonomous OpMode. It runs the tests.robot in a specified distance
 * forward and to the left. On reaching the end of the forward Path, the tests.robot runs the backward
...
public class CurvedBackAndForth extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("This will run the tests.robot in a curve going " + DISTANCE + " inches"
                            + " to the left and the same number of inches forward. The tests.robot will go"
